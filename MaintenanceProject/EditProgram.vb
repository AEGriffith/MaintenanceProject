...
Public Class EditProgram
    ...
    Private Sub EditProgram_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            Advising.refreshProgram()
            StudentProfile.setLblProgram(Advising.getProgram)
            Dim rightAlignConcentration As Integer = StudentProfile.lblConcentration.Left + StudentProfile.lblConcentration.Width
            StudentProfile.setlblConcentration(Advising.getConcentration)
            StudentProfile.lblConcentration.Left = rightAlignConcentration - StudentProfile.lblConcentration.Width
            Me.Close()
        End If
    End Sub
